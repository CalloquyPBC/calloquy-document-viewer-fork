...
import 'pdf.js/build/generic/build/pdf';
// import {PDFViewerApplication} from "pdf.js/web/app.js";

@Component({
  tag: 'my-component',
  styleUrls: [
    '../../../../../node_modules/pdf.js/build/generic/web/viewer.css',
    'my-component.css',
  ],
  shadow: false,
  assetsDirs: ['images']
...
export class MyComponent {
  ...
  async componentDidLoad() {
    ...
    this.setCssAssetVariable(root, '--loading-icon', 'images/loading.svg');
    this.setCssAssetVariable(root, '--loading-icon', 'images/loading.svg');
    this.setCssAssetVariable(root, '--treeitem-expanded-icon', 'images/treeitem-expanded.svg');
    this.setCssAssetVariable(root, '--treeitem-collapsed-icon', 'images/treeitem-collapsed.svg');
    this.setCssAssetVariable(root, '--toolbarButton-editorFreeText-icon', 'images/toolbarButton-editorFreeText.svg');
    this.setCssAssetVariable(root, '--toolbarButton-editorInk-icon', 'images/toolbarButton-editorInk.svg');
    this.setCssAssetVariable(root, '--toolbarButton-menuArrow-icon', 'images/toolbarButton-menuArrow.svg');
    this.setCssAssetVariable(root, '--toolbarButton-sidebarToggle-icon', 'images/toolbarButton-sidebarToggle.svg');
    this.setCssAssetVariable(root, '--toolbarButton-secondaryToolbarToggle-icon', 'images/toolbarButton-secondaryToolbarToggle.svg');
    this.setCssAssetVariable(root, '--toolbarButton-pageUp-icon', 'images/toolbarButton-pageUp.svg');
    this.setCssAssetVariable(root, '--toolbarButton-pageDown-icon', 'images/toolbarButton-pageDown.svg');
    this.setCssAssetVariable(root, '--toolbarButton-zoomOut-icon', 'images/toolbarButton-zoomOut.svg');
    this.setCssAssetVariable(root, '--toolbarButton-zoomIn-icon', 'images/toolbarButton-zoomIn.svg');
    this.setCssAssetVariable(root, '--toolbarButton-presentationMode-icon', 'images/toolbarButton-presentationMode.svg');
    this.setCssAssetVariable(root, '--toolbarButton-print-icon', 'images/toolbarButton-print.svg');
    this.setCssAssetVariable(root, '--toolbarButton-openFile-icon', 'images/toolbarButton-openFile.svg');
    this.setCssAssetVariable(root, '--toolbarButton-download-icon', 'images/toolbarButton-download.svg');
    this.setCssAssetVariable(root, '--toolbarButton-bookmark-icon', 'images/toolbarButton-bookmark.svg');
    this.setCssAssetVariable(root, '--toolbarButton-viewThumbnail-icon', 'images/toolbarButton-viewThumbnail.svg');
    this.setCssAssetVariable(root, '--toolbarButton-viewOutline-icon', 'images/toolbarButton-viewOutline.svg');
    this.setCssAssetVariable(root, '--toolbarButton-viewAttachments-icon', 'images/toolbarButton-viewAttachments.svg');
    this.setCssAssetVariable(root, '--toolbarButton-viewLayers-icon', 'images/toolbarButton-viewLayers.svg');
    this.setCssAssetVariable(root, '--toolbarButton-currentOutlineItem-icon', 'images/toolbarButton-currentOutlineItem.svg');
    this.setCssAssetVariable(root, '--toolbarButton-search-icon', 'images/toolbarButton-search.svg');
    this.setCssAssetVariable(root, '--findbarButton-previous-icon', 'images/findbarButton-previous.svg');
    this.setCssAssetVariable(root, '--findbarButton-next-icon', 'images/findbarButton-next.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-firstPage-icon', 'images/secondaryToolbarButton-firstPage.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-lastPage-icon', 'images/secondaryToolbarButton-lastPage.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-rotateCcw-icon', 'images/secondaryToolbarButton-rotateCcw.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-rotateCw-icon', 'images/secondaryToolbarButton-rotateCw.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-selectTool-icon', 'images/secondaryToolbarButton-selectTool.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-handTool-icon', 'images/secondaryToolbarButton-handTool.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-scrollPage-icon', 'images/secondaryToolbarButton-scrollPage.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-scrollVertical-icon', 'images/secondaryToolbarButton-scrollVertical.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-scrollHorizontal-icon', 'images/secondaryToolbarButton-scrollHorizontal.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-scrollWrapped-icon', 'images/secondaryToolbarButton-scrollWrapped.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-spreadNone-icon', 'images/secondaryToolbarButton-spreadNone.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-spreadOdd-icon', 'images/secondaryToolbarButton-spreadOdd.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-spreadEven-icon', 'images/secondaryToolbarButton-spreadEven.svg');
    this.setCssAssetVariable(root, '--secondaryToolbarButton-documentProperties-icon', 'images/secondaryToolbarButton-documentProperties.svg');


  }

  setCssAssetVariable(root: HTMLElement, name: string, path) {
        ...
        <div id="outerContainer">
          ...
          <div id="mainContainer">
            <div class="findbar hidden doorHanger" id="findbar">
              ...
              <div id="findbarOptionsOneContainer">
                ...
                <label htmlFor="findMatchCase" class="toolbarLabel" data-l10n-id="find_match_case_label">Match
                  Case</label>
              </div>
              <div id="findbarOptionsTwoContainer">
                ...
                <label htmlFor="findEntireWord" class="toolbarLabel" data-l10n-id="find_entire_word_label">Whole
                  Words</label>
              </div>
                ...
                <div id="toolbarViewer">
                  ...
                  <div id="toolbarViewerRight">
                    ...
                    <div id="editorModeButtons" class="splitToolbarButton toggled" role="radiogroup">
                      ...
                      <button id="editorInk" class="toolbarButton" disabled title="Draw" role="radio"
          ...
          <div id="dialogContainer">
            <dialog id="passwordDialog">
              <div class="row">
                <label htmlFor="password" id="passwordText" data-l10n-id="password_label">Enter the password to open
                  this PDF file:</label>
              </div>
              <div class="row">
