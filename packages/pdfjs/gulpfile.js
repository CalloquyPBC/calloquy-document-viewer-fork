...
function createMainBundle(defines) {
  const mainAMDName = "pdf.js/build/generic/build/pdf";
...
function createScriptingBundle(defines, extraOptions = undefined) {
  const scriptingAMDName = "pdf.js/build/generic/build/pdf.scripting";
...
function createSandboxBundle(defines, extraOptions = undefined) {
  const sandboxAMDName = "pdf.js/build/generic/build/pdf.sandbox";
...
function createWorkerBundle(defines) {
  const workerAMDName = "pdf.js/build/generic/build/pdf.worker";
